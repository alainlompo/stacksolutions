...
public class MitchellBestCandidateII extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3829905093575918192L;
	...
	private static final Color[] BASIC_COLORS = {Color.BLUE, Color.RED, Color.GREEN, Color.MAGENTA};
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				new MitchellBestCandidateII().setVisible(true);

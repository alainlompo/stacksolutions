...
public class Rotation45 {
    public static void main(String[] args) throws IOException {
        String filename = "C:\\Hypernovae\\Business\\2015\\StackOverflow\\FilesStuff\\abcd.csv";
        ...
        try {
            ...
            writer = new BufferedWriter(new FileWriter("C:\\Hypernovae\\Business\\2015\\StackOverflow\\FilesStuff\\abcdNew.csv"));     
            double a1 = 0.866025;
            double a2 = 0.5;
            double a3 = -0.5;
            double a4 = 0.866025;
